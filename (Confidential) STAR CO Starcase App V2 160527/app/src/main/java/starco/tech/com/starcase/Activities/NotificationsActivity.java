...
public class NotificationsActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        logo.setImageResource(R.drawable.notifications_icon);

        boxOne.setColorFilter(UserPreferences.getNotificationsBoxOneColor(getApplicationContext()).getRGB());

        switch(UserPreferences.getNotificationsBoxOne(getApplicationContext()))
        {
            case CALL_ICON:
                boxOne.setImageResource(R.drawable.notifications_icon);
                break;
        ...
        boxTwo.setTextColor(UserPreferences.getNotificationsBoxTwoColor(getApplicationContext()).getRGB());
        boxTwo.setText(UserPreferences.getNotificationsBoxTwo(getApplicationContext()).getText());

        boxThree.setTextColor(UserPreferences.getNotificationsBoxThreeColor(getApplicationContext()).getRGB());
        boxThree.setText(UserPreferences.getNotificationsBoxThree(getApplicationContext()).getText());

        boxFour.setBackgroundColor(UserPreferences.getNotificationsBoxFourColor(getApplicationContext()).getRGB());
        ...
        names[0] = UserPreferences.getNotificationsBoxOne(this).getText();
        names[1] = UserPreferences.getNotificationsBoxTwo(this).getText();
        names[2] = UserPreferences.getNotificationsBoxThree(this).getText();

        colors[0] = UserPreferences.getNotificationsBoxOneColor(this).getRGB();
        colors[1] = UserPreferences.getNotificationsBoxTwoColor(this).getRGB();
        colors[2] = UserPreferences.getNotificationsBoxThreeColor(this).getRGB();
        colors[3] = UserPreferences.getNotificationsBoxFourColor(this).getRGB();
        ...
        adapter = new DisplayListAdapter(this, names, colors, MenuType.NOTIFICATION, handler);
